          ...
          <div class="modal-body">
            ...
            <div class="row g-4">
              ...
              <div class="col-12 col-lg-6">
                ...
                <div id="mainProductCarousel" class="carousel slide"
                  ...
                  <button class="carousel-control-prev" type="button"
                          data-bs-target="#mainProductCarousel" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon"></span>
                  </button>

                  <button class="carousel-control-next" type="button"
                          data-bs-target="#mainProductCarousel" data-bs-slide="next">
                ...
                <div class="d-flex justify-content-center gap-2 mt-3 flex-wrap">
                  ...
                  ${imagenes.map((img, index) => `
                    <button type="button"
                      data-bs-target="#mainProductCarousel"
              ...
              <div class="col-12 col-lg-6">
                ...
                <span class="badge bg-secondary mb-2">
                  ${(String(producto.categoria || "")).toUpperCase()}
                </span>
                ...
                <div class="mt-4">
                  ...
                  ${botones(
                    ...
                    "button",
                    `data-sku="${producto.modeloProducto?.sku}" data-id="${producto.id}"`
                  )}
                </div>
